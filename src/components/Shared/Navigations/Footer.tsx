      ...
      <div className="w-full bg-black-main py-5 md:px-10 px-4">
        <div className="w-full h-full max-w-[1430px] mx-auto">
          <div className="w-full grid md:grid-cols-[.5fr,1fr,1fr,2fr,1fr] gap-6 py-2 border-b border-b-white-main/40">
            <a
              href="#"
              className="h-[40px] w-[40px] flex items-center justify-center border border-white-main rounded-full"
            >
              <BsArrowUp className="text-2xl text-white-main" />
            </a>
            <div className="w-full flex flex-col items-start justify-start gap-1">
              <p className="text-white-main/40 text-xs font-medium">Contact</p>
            ...
            <div className="w-full flex flex-col items-start justify-start gap-1">
              <p className="text-white-main/40 text-xs font-medium">Address</p>
              <p className="text-white-main text-xs font-medium">
