  ...
  return (
    ...
    >
      <Slide className="w-full" triggerOnce direction="left">
        <div className="w-full h-full flex flex-col items-center justify-center gap-8 xl:pl-[70px] lg:pl-[40px] px-4 md:px-10 lg:pr-0 lg:mt-[400px]">
          <h2 className="text-white-off text-center sm:text-5xl text-3xl leading-[44px] font-medium">
